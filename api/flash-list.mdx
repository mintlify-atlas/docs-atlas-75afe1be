...
<ParamField path="estimatedItemSize" type="number">
  **Strongly recommended.** Approximate size of items in pixels. Providing this improves initial render performance and scroll position accuracy.
  
  For vertical lists, this is the height. For horizontal lists, this is the width.
